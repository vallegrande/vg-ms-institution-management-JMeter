...
import pe.edu.vallegrande.sigei.vgmsinstitutionmanagement.domain.ports.in.IRestoreClassroomUseCase;
...
public class RestoreClassroomUseCaseImpl implements IRestoreClassroomUseCase {
